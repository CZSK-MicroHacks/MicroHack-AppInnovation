"""Executable contract freeze for the shared workshop challenges."""
...
def _validate(schema: dict, instance: object) -> None:
    """Validate one shared-challenge contract instance with strict format checking."""
...
def _normalized_observations(
    ...
    """Build normalized observations for one schema-valid shared-challenge example."""
...
def test_p6_registry_freezes_disjoint_artifact_ownership(repo_root: Path) -> None:
    ...
    expected = {
        "load-autoscaling": {
            ...
            "artifacts": [
                ...
                "tests/acceptance/tests/test_ch02_load_challenge.py",
            ],
            ...
            "validationCommand": (
                "uv --no-config run pytest -q tests/test_ch02_load_challenge.py"
            ),
        },
        "cicd-revisions": {
            "id": "cicd-revisions",
            ...
            "validationCommand": (
                "uv --no-config run pytest -q tests/test_ch03_cicd_challenge.py"
            ),
        },
        "observability": {
            "id": "observability",
    ...
    assert coordinator_owned == {
        ...
        "tests/acceptance/tests/test_challenge_contracts.py",
        "tests/acceptance/tests/test_ch02_load_renderer.py",
    }
...
def test_p6_validator_accepts_complete_handoff_bound_evidence(
    ...
    """Every shared-challenge producer can satisfy the common executable validator."""
