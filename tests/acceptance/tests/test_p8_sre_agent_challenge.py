"""Static acceptance tests for the P8 SRE Agent vertical slice."""
...
def test_sre_bicep_consumes_the_frozen_resource_contract(repo_root: Path) -> None:
    """The entry point and modules deploy only the frozen P8 resource shape."""
...
def test_facilitator_cleanup_is_authorized_and_protects_the_handoff(
    ...
    assert "ARM GET every protected P5/P6 handoff resource" in guide
