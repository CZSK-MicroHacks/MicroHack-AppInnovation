...
def test_defender_registry_and_examples_are_schema_valid() -> None:
    """Freeze every P7 registry, capture, report, profile, and cleanup schema."""
...
def test_renderer_consumes_registry_from_the_active_repository(
    ...
    """Prove rendering cannot borrow the installed package's P7 registry."""
    root = _copy_bundle(tmp_path)
...
def test_renderer_consumes_schemas_from_the_active_repository(
    ...
    """Prove rendering cannot borrow the installed package's P7 schemas."""
    root = _copy_bundle(tmp_path)
    schema_path = (
